...
import { userNameAtom, userRoleAtom, roomIDAtom, itemsAtom } from './store/atoms';


function App() {
  const [userRole] = useAtom(userRoleAtom);    // 从全局状态获取用户角色
  const [userName] = useAtom(userNameAtom);     // 从全局状态获取用户名称
